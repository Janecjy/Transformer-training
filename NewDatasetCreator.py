...
import pickle
with open('./NEWDatasets/FullDataset_alt.p', 'wb') as f:
    pickle.dump(data_dict, f, pickle.HIGHEST_PROTOCOL)

with open('./NEWDatasets/FullDataset_alt.p','rb') as f:
...
with open('./NEWDatasets/FullDataset_alt-test.p', 'wb') as f:
    pickle.dump(dataset[train_samples:,:,:], f, pickle.HIGHEST_PROTOCOL)

with open('./NEWDatasets/FullDataset_alt-train.p', 'wb') as f:
    pickle.dump(dataset[:train_samples, :,:], f, pickle.HIGHEST_PROTOCOL)